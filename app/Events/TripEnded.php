...
use App\Http\Resources\API\V1\Driver\TripRiderResource as DriverTripRiderResource;
use App\Models\Trip;
...
class TripEnded implements ShouldBroadcast
{
    ...
    {
        $this->trip->load(['driver.user', 'driver.vehicle', 'user', 'payment']);
        ...
        return [
            ...
            'invoice' => TripInvoiceResource::make($this->trip),
